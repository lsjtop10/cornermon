...
structs = [
    ...
    'DeviceRegistration', 'Group', 'Track', 'FacilitatorSession', 'Message', 'Camp', 'Corner'
]
...
def process_file(path):
    ...
    for struct in structs:
        # Match `domain.Struct{` but NOT `[]domain.Struct{`
        # We can use lookbehind `(?<!\[\])`
        ...
        while True:
            ...
            # Make sure it's not preceded by & which we handle below
...
print("Fixed structs in tests without breaking slices.")
