...
@riverpod
EMessagesApi messageApi(Ref ref) {
  final dio = ref.watch(apiClientProvider);
  return EMessagesApi(dio, serializers);
}

@riverpod
Future<List<Message>> broadcastMessageList(Ref ref) async {
...
@riverpod
Future<List<Message>> trackMessageList(Ref ref, TrackId trackId) async {
  final apiInstance = ref.watch(messageApiProvider);
