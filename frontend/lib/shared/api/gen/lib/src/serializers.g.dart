    ...
    (Serializers().toBuilder()
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(CampSummaryStatsBottleneckRankingInner),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(CornerStatsUnvisitedGroupsInner),
            ]),
            () => ListBuilder<CornerStatsUnvisitedGroupsInner>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(CornerStatsTrackThroughputsInner),
            ]),
            () => ListBuilder<CornerStatsTrackThroughputsInner>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(CornersPostRequestCornersInner),
            ]),
            () => ListBuilder<CornersPostRequestCornersInner>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(DeviceRegistration),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(GroupStatsCornerDurationsInner),
            ]),
            () => ListBuilder<GroupStatsCornerDurationsInner>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(GroupStatsUnvisitedCornersInner),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(OperationalStatsAdminActionCountsInner),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(OperationalStatsBroadcastReadRatesInner),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(TimelineStatsInProgressCountsInner),
            ]),
