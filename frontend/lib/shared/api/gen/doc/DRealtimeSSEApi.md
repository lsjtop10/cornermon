...
------------- | ------------- | -------------
[**eventsAdminGet**](DRealtimeSSEApi.md#eventsadminget) | **GET** /events/admin | 관리자 대시보드 SSE 스트림 (얇은 변경 알림)
[**eventsTrackTrackIdGet**](DRealtimeSSEApi.md#eventstracktrackidget) | **GET** /events/track/{trackId} | 진행자 앱 SSE 스트림 (얇은 변경 알림)
