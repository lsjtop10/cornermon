...
TrackResponse _track(String id, String cornerId) =>
    TrackResponse((b) => b..id = id..cornerId = cornerId);
...
void main() {
  group('groupTracksByCorner', () {
    ...
    test('ShouldAssignTrackToItsOwnCornerWhenMultipleCornersExist', () {
      ...
      expect(c1.canDelete, isFalse);
    });

    test('ShouldReturnFalseForCanDeleteWhenCornerHasTracks', () {
      // arrange
