...
class BCampCornerTrackApi {
  ...
  Future<Response<TrackLoginResponse>> tracksIdMigrateSessionPost({ 
    required String id,
    ...
    final _path = r'/tracks/{id}/migrate-session'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
